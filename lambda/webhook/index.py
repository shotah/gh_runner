...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Handle GitHub webhook events and trigger runner Lambda for workflow_job events
    """
    try:
        ...
        if event_type == 'workflow_job':
            ...
            if action == 'queued':
                ...
                if 'self-hosted' in labels or 'lambda-runner' in labels:
                    print(f'Triggering runner for job {workflow_job.get("id")}')
                    ...
                    print(f'Job labels do not match self-hosted runner criteria')
